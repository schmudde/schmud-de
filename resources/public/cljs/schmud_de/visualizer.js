...
return (amplitude * p1__6248_SHARP_);
});})(rads,ys))
,ys);
return scaled_ys;
});
...
var tr__6172__auto__ = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(quil.core.height.call(null) / (2))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__6172__auto__);
...
while (G__6250__i < G__6250__a.length) {G__6250__a[G__6250__i] = arguments[G__6250__i + 0]; ++G__6250__i;}
  args = new cljs.core.IndexedSeq(G__6250__a,0);
} 
...
if(cljs.core.truth_(cljs.core.some.call(null,(function (p1__5804__5805__auto__){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"no-start","no-start",1381488856),p1__5804__5805__auto__);
}),null))){
} else {
