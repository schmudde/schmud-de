...
return (amplitude * p1__9685_SHARP_);
});})(xs,rads,ys))
,ys);
var resolution = (30);
...
var tr__9609__auto__ = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(quil.core.height.call(null) / (2))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__9609__auto__);
...
var G__9689__delegate = function (args){
return cljs.core.apply.call(null,schmud_de.visualizer.draw,args);
};
var G__9689 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
return G__9689__delegate.call(this,args);};
G__9689.cljs$lang$maxFixedArity = 0;
G__9689.cljs$lang$applyTo = (function (arglist__9691){
var args = cljs.core.seq(arglist__9691);
return G__9689__delegate(args);
});
...
if(cljs.core.truth_(cljs.core.some.call(null,(function (p1__9241__9242__auto__){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"no-start","no-start",1381488856),p1__9241__9242__auto__);
}),null))){
} else {
