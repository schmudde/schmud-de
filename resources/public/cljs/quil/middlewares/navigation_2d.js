...
return cljs.core.merge.call(null,initial_state,p1__10720_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_10721 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_10722 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_10721);
var pos_10723 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_10721);
quil.core.scale.call(null,zoom_10722);

var tr__9931__auto___10724 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_10722) - cljs.core.first.call(null,pos_10723)),(((quil.core.height.call(null) / (2)) / zoom_10722) - cljs.core.second.call(null,pos_10723))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__9931__auto___10724);
