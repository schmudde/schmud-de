...
var vec__19042 = axis;
var a_x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19042,(0),null);
var a_y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19042,(1),null);
var a_z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19042,(2),null);
var vec__19043 = v;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19043,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19043,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19043,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__19044,p__19045){
var vec__19048 = p__19044;
var u1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19048,(0),null);
var u2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19048,(1),null);
var u3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19048,(2),null);
var vec__19049 = p__19045;
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19049,(0),null);
var v2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19049,(1),null);
var v3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19049,(2),null);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__19050_SHARP_){
return (p1__19050_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle(p1__19051_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud(quil.middlewares.navigation_3d.rotate_lr(p1__19052_SHARP_,angle_lr),angle_ud);
...
var map__19059 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__19059__$1 = ((((!((map__19059 == null)))?((((map__19059.cljs$lang$protocol_mask$partition0$ & (64))) || (map__19059.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__19059):map__19059);
var up = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19059__$1,cljs.core.cst$kw$up);
var straight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19059__$1,cljs.core.cst$kw$straight);
var temp__4423__auto__ = (function (){var pred__19061 = cljs.core._EQ_;
var expr__19062 = cljs.core.cst$kw$key.cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_((pred__19061.cljs$core$IFn$_invoke$arity$2 ? pred__19061.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$w,expr__19062) : pred__19061.call(null,cljs.core.cst$kw$w,expr__19062)))){
return straight;
} else {
if(cljs.core.truth_((pred__19061.cljs$core$IFn$_invoke$arity$2 ? pred__19061.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$s,expr__19062) : pred__19061.call(null,cljs.core.cst$kw$s,expr__19062)))){
return quil.middlewares.navigation_3d.v_opposite(straight);
} else {
if(cljs.core.truth_((pred__19061.cljs$core$IFn$_invoke$arity$2 ? pred__19061.cljs$core$IFn$_invoke$arity$2(quil.middlewares.navigation_3d.space,expr__19062) : pred__19061.call(null,quil.middlewares.navigation_3d.space,expr__19062)))){
return quil.middlewares.navigation_3d.v_opposite(up);
} else {
if(cljs.core.truth_((pred__19061.cljs$core$IFn$_invoke$arity$2 ? pred__19061.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$z,expr__19062) : pred__19061.call(null,cljs.core.cst$kw$z,expr__19062)))){
return up;
} else {
if(cljs.core.truth_((pred__19061.cljs$core$IFn$_invoke$arity$2 ? pred__19061.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$d,expr__19062) : pred__19061.call(null,cljs.core.cst$kw$d,expr__19062)))){
return quil.middlewares.navigation_3d.cross_product(straight,up);
} else {
if(cljs.core.truth_((pred__19061.cljs$core$IFn$_invoke$arity$2 ? pred__19061.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$a,expr__19062) : pred__19061.call(null,cljs.core.cst$kw$a,expr__19062)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigation_DASH_3d,cljs.core.cst$kw$position], null),((function (dir,temp__4423__auto__,map__19059,map__19059__$1,up,straight){
return (function (p1__19053_SHARP_){
return quil.middlewares.navigation_3d.v_plus(p1__19053_SHARP_,quil.middlewares.navigation_3d.v_mult(dir,step_size));
});})(dir,temp__4423__auto__,map__19059,map__19059__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([initial_state,p1__19064_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var rotate_on_fn = (function (){var G__19076 = options;
var G__19077 = ((function (G__19076,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed){
return (function (state,_){
return state;
});})(G__19076,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed))
;
return (rotate_on.cljs$core$IFn$_invoke$arity$2 ? rotate_on.cljs$core$IFn$_invoke$arity$2(G__19076,G__19077) : rotate_on.call(null,G__19076,G__19077));
})();
...
var map__19078_19087 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__19078_19088__$1 = ((((!((map__19078_19087 == null)))?((((map__19078_19087.cljs$lang$protocol_mask$partition0$ & (64))) || (map__19078_19087.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__19078_19087):map__19078_19087);
var vec__19079_19089 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19078_19088__$1,cljs.core.cst$kw$straight);
var c_x_19090 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19079_19089,(0),null);
var c_y_19091 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19079_19089,(1),null);
var c_z_19092 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19079_19089,(2),null);
var vec__19080_19093 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19078_19088__$1,cljs.core.cst$kw$up);
var u_x_19094 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19080_19093,(0),null);
var u_y_19095 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19080_19093,(1),null);
var u_z_19096 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19080_19093,(2),null);
var vec__19081_19097 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19078_19088__$1,cljs.core.cst$kw$position);
var p_x_19098 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19081_19097,(0),null);
var p_y_19099 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19081_19097,(1),null);
var p_z_19100 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19081_19097,(2),null);
quil.core.camera.cljs$core$IFn$_invoke$arity$9(p_x_19098,p_y_19099,p_z_19100,(p_x_19098 + c_x_19090),(p_y_19099 + c_y_19091),(p_z_19100 + c_z_19092),u_x_19094,u_y_19095,u_z_19096);
...
var G__19083 = quil.middlewares.navigation_3d.move(state,event,step_size);
var G__19084 = event;
return (key_pressed.cljs$core$IFn$_invoke$arity$2 ? key_pressed.cljs$core$IFn$_invoke$arity$2(G__19083,G__19084) : key_pressed.call(null,G__19083,G__19084));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
,rotate_on,((function (user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup){
return (function (state,event){
var G__19085 = quil.middlewares.navigation_3d.rotate(state,event,pixels_in_360);
var G__19086 = event;
return (rotate_on_fn.cljs$core$IFn$_invoke$arity$2 ? rotate_on_fn.cljs$core$IFn$_invoke$arity$2(G__19085,G__19086) : rotate_on_fn.call(null,G__19085,G__19086));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
], 0));
});
