...
var vec__10729 = axis;
var a_x = cljs.core.nth.call(null,vec__10729,(0),null);
var a_y = cljs.core.nth.call(null,vec__10729,(1),null);
var a_z = cljs.core.nth.call(null,vec__10729,(2),null);
var vec__10730 = v;
var x = cljs.core.nth.call(null,vec__10730,(0),null);
var y = cljs.core.nth.call(null,vec__10730,(1),null);
var z = cljs.core.nth.call(null,vec__10730,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__10731,p__10732){
var vec__10735 = p__10731;
var u1 = cljs.core.nth.call(null,vec__10735,(0),null);
var u2 = cljs.core.nth.call(null,vec__10735,(1),null);
var u3 = cljs.core.nth.call(null,vec__10735,(2),null);
var vec__10736 = p__10732;
var v1 = cljs.core.nth.call(null,vec__10736,(0),null);
var v2 = cljs.core.nth.call(null,vec__10736,(1),null);
var v3 = cljs.core.nth.call(null,vec__10736,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__10737_SHARP_){
return (p1__10737_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__10738_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__10739_SHARP_,angle_lr),angle_ud);
...
var map__10746 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__10746__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__10746__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4423__auto__ = (function (){var pred__10748 = cljs.core._EQ_;
var expr__10749 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__10748.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__10749))){
return straight;
} else {
if(cljs.core.truth_(pred__10748.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__10749))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__10748.call(null,quil.middlewares.navigation_3d.space,expr__10749))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__10748.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__10749))){
return up;
} else {
if(cljs.core.truth_(pred__10748.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__10749))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__10748.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__10749))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4423__auto__,map__10746,map__10746__$1,up,straight){
return (function (p1__10740_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__10740_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4423__auto__,map__10746,map__10746__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__10751_SHARP_);
});})(initial_state))
);
});
/**
...
var map__10757_10762 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__10757_10763__$1 = ((((!((map__10757_10762 == null)))?((((map__10757_10762.cljs$lang$protocol_mask$partition0$ & (64))) || (map__10757_10762.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10757_10762):map__10757_10762);
var vec__10758_10764 = cljs.core.get.call(null,map__10757_10763__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_10765 = cljs.core.nth.call(null,vec__10758_10764,(0),null);
var c_y_10766 = cljs.core.nth.call(null,vec__10758_10764,(1),null);
var c_z_10767 = cljs.core.nth.call(null,vec__10758_10764,(2),null);
var vec__10759_10768 = cljs.core.get.call(null,map__10757_10763__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_10769 = cljs.core.nth.call(null,vec__10759_10768,(0),null);
var u_y_10770 = cljs.core.nth.call(null,vec__10759_10768,(1),null);
var u_z_10771 = cljs.core.nth.call(null,vec__10759_10768,(2),null);
var vec__10760_10772 = cljs.core.get.call(null,map__10757_10763__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_10773 = cljs.core.nth.call(null,vec__10760_10772,(0),null);
var p_y_10774 = cljs.core.nth.call(null,vec__10760_10772,(1),null);
var p_z_10775 = cljs.core.nth.call(null,vec__10760_10772,(2),null);
quil.core.camera.call(null,p_x_10773,p_y_10774,p_z_10775,(p_x_10773 + c_x_10765),(p_y_10774 + c_y_10766),(p_z_10775 + c_z_10767),u_x_10769,u_y_10770,u_z_10771);
