...
goog.provide('quil.helpers.drawing');
 ...
 * [2 5 1 3 6 2])
 */
quil.helpers.drawing.line_join_points = (function quil$helpers$drawing$line_join_points(){
var args5617 = [];
...
switch (G__5619) {
case 1:
return quil.helpers.drawing.line_join_points.cljs$core$IFn$_invoke$arity$1((arguments[(0)]));

break;
case 2:
return quil.helpers.drawing.line_join_points.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));

break;
case 3:
return quil.helpers.drawing.line_join_points.cljs$core$IFn$_invoke$arity$3((arguments[(0)]),(arguments[(1)]),(arguments[(2)]));
...
quil.helpers.drawing.line_join_points.cljs$core$IFn$_invoke$arity$1 = (function (interleaved_points){
...
return cljs.core.cons.call(null,cljs.core.apply.call(null,cljs.core.concat,head),quil.helpers.drawing.line_join_points.call(null,cljs.core.drop.call(null,(1),interleaved_points)));
} else {
return null;
}
}),null,null));
...
quil.helpers.drawing.line_join_points.cljs$lang$maxFixedArity = 3;
